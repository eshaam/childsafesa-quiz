    ...
    <section className='text-center'>
      <div className="row">
        <div className="col-sm-12">
          <h2 className='display-5'>You scored {score} out of {questions.length} </h2>
        </div>
      </div> 
      <div className="row py-4 border-top border-bottom my-3">
        ...
        <div className="col-sm-3">
        <a target="_blank"  href={'http://twitter.com/share?text=' + shareText  + '&url=' + website} class="text-decoration-none">   
        ...
        <div className="col-sm-3">
        <a target="_blank"  href={'mailto:?subject=' + shareText  + ';body=' + website} className="text-decoration-none">   
        ...
        <div className="col-sm-3">
        <a target="_blank"  href={website} className="text-decoration-none">   
